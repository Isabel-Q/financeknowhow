...
export const glossaryTerms: GlossaryTerm[] = [
  {
    ...
    region: "全球通用",
    category: "报表基础",
    definition: "按照适用会计准则判断一项交易是否、何时、以多少金额计入收入的过程。",
    plain: "不是签了合同、开了发票或收了钱就一定能算收入。收入确认是在问：公司有没有真正完成该完成的交付，风险和控制权是否已经转移。",
    distinctions: [
      { label: "收入确认 vs 收款", detail: "收款是现金进账，收入确认是会计上承认业绩；预收款可能先成为负债。" },
      { label: "收入确认 vs 开票", detail: "开票是税务和票据动作，不必然等于会计收入已经满足确认条件。" },
    ],
  ...
  },
  {
    ...
    region: "全球通用",
    category: "报表基础",
    definition: "按照经济业务发生的权利和义务确认收入、费用、资产和负债，而不是只看现金收付。",
    plain: "公司已经提供服务但客户还没付款，可能也要确认收入；公司已经使用供应商服务但还没付款，也可能要确认费用。",
    distinctions: [
      { label: "权责发生制 vs 收付实现制", detail: "前者看业务发生，后者看现金进出；公司报表通常以权责发生制为基础。" },
      { label: "收入 vs 回款", detail: "收入可能先发生，回款后来；这就是为什么利润和现金流经常不一致。" },
    ],
    whyItMatters: "CEO 如果只按银行流水理解公司业绩，会误判收入、费用和利润质量。",
  },
  {
    term: "收付实现制",
    alias: "Cash Basis",
    region: "全球通用",
    category: "报表基础",
    definition: "以现金实际收到或支付作为记录依据的口径。",
    plain: "钱进来才算收入，钱出去才算支出。它更像看钱包，但不能完整反映公司已经发生的业务责任。",
    distinctions: [
      { label: "收付实现制 vs 权责发生制", detail: "收付实现制适合看现金压力；权责发生制适合看业务成果和责任。" },
      { label: "现金账 vs 管理报表", detail: "现金账能说明余额变化，管理报表还要解释收入质量、成本结构和未来义务。" },
    ],
    whyItMatters: "现金视角很重要，但如果只看现金，会低估应收、应付、递延收入等经营风险。",
  },
  {
    term: "资产负债表",
    alias: "Balance Sheet",
    region: "全球通用",
    category: "报表基础",
    definition: "反映公司在某一时点拥有的资产、承担的负债和归属于股东的权益的报表。",
    plain: "这张表像公司某一天的体检照：手里有什么、欠别人什么、股东还剩多少家底。",
    distinctions: [
      { label: "资产负债表 vs 利润表", detail: "资产负债表看某一时点的结构；利润表看一段期间的经营结果。" },
      { label: "资产 vs 费用", detail: "资产未来还能带来价值；费用通常已经消耗掉并影响当期利润。" },
    ],
    whyItMatters: "它比利润表更早暴露应收、存货、短债和净资产压力。",
  },
  {
    term: "利润表",
    alias: "Income Statement / P&L",
    region: "全球通用",
    category: "报表基础",
    definition: "反映公司在一定期间内收入、成本、费用和利润形成过程的报表。",
    plain: "它回答公司这段时间怎么赚钱或亏钱：卖了多少、直接成本多少、团队和运营花了多少、最后剩多少。",
    distinctions: [
      { label: "利润表 vs 现金流量表", detail: "利润表看赚不赚钱；现金流量表看钱有没有真实流入。" },
      { label: "净利润 vs EBITDA", detail: "净利润扣除更多会计和税务项目；EBITDA更接近经营层面的盈利能力观察。" },
    ],
    whyItMatters: "CEO 不能只看净利润，还要看收入质量、毛利率和费用结构。",
  },
  {
    term: "现金流量表",
    ...
    region: "全球通用",
    category: "报表基础",
    definition: "反映公司在一定期间内现金和现金等价物流入、流出的报表，通常分为经营、投资和融资活动。",
    plain: "它回答钱到底从哪里来、花到哪里去。公司账面赚钱但现金变少，问题通常会在这张表里露出来。",
    distinctions: [
      { label: "经营现金流 vs 融资现金流", detail: "经营现金流来自业务本身；融资现金流来自股东、银行或投资人。" },
      { label: "现金流 vs 利润", detail: "利润按会计规则计算，现金流按真实现金进出呈现。" },
    ],
    whyItMatters: "很多公司不是先死于亏损，而是先死于现金流断裂。",
  },
  {
    term: "资产",
    alias: "Assets",
    region: "全球通用",
    category: "报表基础",
    definition: "公司拥有或控制、预期能带来经济利益的资源。",
    plain: "资产不是买过的所有东西，而是未来还能帮公司赚钱、节省成本或换成现金的东西。",
    distinctions: [
      { label: "资产 vs 费用", detail: "资产的价值会延续到未来；费用通常是当期已经消耗的支出。" },
      { label: "流动资产 vs 非流动资产", detail: "流动资产通常一年内可变现或消耗；非流动资产使用周期更长。" },
    ],
    whyItMatters: "资产质量决定公司抗风险能力，尤其是现金、应收、存货和长期资产是否真实有用。",
  },
  {
    term: "负债",
    alias: "Liabilities",
    region: "全球通用",
    category: "报表基础",
    definition: "公司因过去交易或事项形成、预期会导致经济利益流出的现时义务。",
    plain: "负债就是公司未来必须还、必须交付或必须承担的责任，不一定只有银行贷款。",
    distinctions: [
      { label: "负债 vs 费用", detail: "费用影响利润；负债是尚未清偿的义务，会影响未来现金。" },
      { label: "应付账款 vs 借款", detail: "应付账款通常来自采购或服务；借款来自融资安排。" },
    ],
    whyItMatters: "负债结构决定公司短期现金压力和长期偿债风险。",
  },
  {
    term: "所有者权益",
    alias: "Equity",
    region: "全球通用",
    category: "报表基础",
    definition: "资产扣除负债后归属于股东的剩余权益。",
    plain: "如果把公司资产全部卖掉、债都还掉，理论上剩下的部分就是股东的权益。",
    distinctions: [
      { label: "权益 vs 现金", detail: "权益是账面净资产概念，不等于公司银行账户里有多少钱。" },
      { label: "注册资本 vs 所有者权益", detail: "注册资本是股东承诺或实缴资本的一部分；所有者权益还包括留存收益等。" },
    ],
    whyItMatters: "权益持续变薄，通常说明公司在消耗资本缓冲。",
  },
  {
    term: "经营现金流",
    ...
    region: "双地",
    category: "现金流与资金",
    definition: "公司经营活动产生的现金流入减去经营活动现金流出的净额。",
    plain: "它看公司靠主业到底是在造血还是流血，不看融资输血，也不看买设备、买投资这些活动。",
    distinctions: [
      { label: "经营现金流 vs 净利润", detail: "净利润可能受应收、折旧、摊销等影响；经营现金流更接近主业现金能力。" },
      { label: "经营现金流 vs 自由现金流", detail: "自由现金流通常还要扣除维持或扩张所需的资本开支。" },
    ],
    whyItMatters: "它最直接回答公司是否靠业务本身在养活自己。",
  },
  {
    term: "自由现金流",
    alias: "Free Cash Flow",
    region: "全球通用",
    category: "现金流与资金",
    definition: "公司经营现金流扣除必要资本开支后，可用于还债、分红、再投资或留存的现金。",
    plain: "经营赚到现金以后，还要先扣掉维持业务必须花的钱，剩下真正自由的钱才更有质量。",
    distinctions: [
      { label: "自由现金流 vs 经营现金流", detail: "经营现金流还没扣资本开支；自由现金流更严格。" },
      { label: "自由现金流 vs 账面利润", detail: "账面利润可能很漂亮，但如果资本开支很大，自由现金流可能很差。" },
    ],
    whyItMatters: "它更能说明公司是否具备长期自我融资能力。",
  },
  {
    term: "Runway",
    alias: "现金跑道",
    region: "全球通用",
    category: "现金流与资金",
    definition: "在当前现金余额和现金消耗速度下，公司还能维持运营的时间。",
    plain: "如果公司每月净烧 50 万，账上有 300 万现金，粗略 runway 就是 6 个月。",
    distinctions: [
      { label: "Runway vs 现金余额", detail: "现金余额是现在有多少钱；runway 把未来消耗速度也考虑进去。" },
      { label: "Runway vs Burn Rate", detail: "Burn rate 是每月消耗速度；runway 是还能撑多久。" },
    ],
    whyItMatters: "CEO 做招聘、投放、融资和扩张决策前，必须知道 runway。",
  },
  {
    term: "Burn Rate",
    alias: "现金消耗速度",
    region: "全球通用",
    category: "现金流与资金",
    definition: "公司在一定期间内净消耗现金的速度，通常按月衡量。",
    plain: "它不是问花了多少钱，而是问扣掉收入回款以后，每个月净少了多少钱。",
    distinctions: [
      { label: "Gross Burn vs Net Burn", detail: "Gross burn 看总支出；net burn 看现金流入抵消后的净消耗。" },
      { label: "Burn Rate vs 亏损", detail: "亏损是利润表概念；burn rate 是现金概念。" },
    ],
    whyItMatters: "它决定融资时间表和成本收缩动作是否来得及。",
  },
  {
    term: "应收账款",
    ...
    region: "双地",
    category: "营运资金",
    definition: "公司因销售商品或提供服务而应向客户收取、但尚未收到的款项。",
    plain: "账上已经把客户欠你的钱记下来了，但钱还没进银行账户。",
    distinctions: [
      { label: "应收账款 vs 收入", detail: "收入是业绩确认；应收账款是尚未收回的客户欠款。" },
      { label: "应收账款 vs 合同资产", detail: "应收账款通常收款权利更明确；合同资产还可能取决于未来履约或验收条件。" },
    ],
  ...
  },
  {
    ...
    region: "双地",
    category: "营运资金",
    definition: "公司因采购商品或接受服务而应向供应商支付、但尚未支付的款项。",
    plain: "别人已经给你货或服务了，但你还没付钱。",
    distinctions: [
      { label: "应付账款 vs 借款", detail: "应付账款来自经营采购；借款来自融资。" },
      { label: "应付账款 vs 预付款", detail: "应付是先收到货或服务后付款；预付款是先付款后取得货或服务。" },
    ],
    whyItMatters: "应付拉长可以缓解现金，但过度拖欠会伤害供应链信用。",
  },
  {
    term: "存货",
    alias: "Inventory",
    region: "双地",
    category: "营运资金",
    definition: "公司持有用于销售、生产或提供服务过程中消耗的商品、材料、在产品和产成品。",
    plain: "库存不是越多越安全。卖不掉、过期、跌价或周转慢，都会把现金锁死。",
    distinctions: [
      { label: "存货 vs 固定资产", detail: "存货是为了销售或生产消耗；固定资产是长期使用。" },
      { label: "存货成本 vs 期间费用", detail: "存货卖出时才转入成本；期间费用通常发生时就影响利润。" },
    ],
    whyItMatters: "存货周转恶化会吞噬现金，并可能导致跌价损失。",
  },
  {
    term: "毛利率",
    alias: "Gross Margin",
    region: "双地",
    category: "经营指标",
    definition: "毛利占收入的比例，通常等于（收入 - 直接成本）/ 收入。",
    plain: "每卖 100 元产品或服务，扣掉直接交付成本后还剩多少钱用于支付团队、销售、研发和利润。",
    distinctions: [
      { label: "毛利率 vs 净利率", detail: "毛利率只扣直接成本；净利率还扣期间费用、税费等。" },
      { label: "毛利率 vs 加价率", detail: "毛利率以售价为分母；加价率通常以成本为分母，不能混用。" },
    ],
  ...
  },
  {
    ...
    region: "双地",
    category: "经营指标",
    definition: "净利润占收入的比例。",
    plain: "公司每卖 100 元，最终扣完成本、费用、税等以后真正留下多少利润。",
    distinctions: [
      { label: "净利率 vs 毛利率", detail: "净利率更接近最终盈利结果；毛利率更接近产品或服务本身的经济性。" },
      { label: "净利润 vs 现金流", detail: "净利润是会计结果，现金流看真实收付。" },
    ],
    whyItMatters: "它能反映商业模式、费用控制和税负综合后的结果。",
  },
  {
    term: "EBITDA",
    region: "全球通用",
    category: "经营指标",
    definition: "息税折旧摊销前利润，用于观察企业经营层面的盈利能力。",
    plain: "它先把利息、税、折旧、摊销这些因素拿掉，看业务本身大致能不能赚钱。",
    distinctions: [
      { label: "EBITDA vs 净利润", detail: "EBITDA不扣利息、税、折旧和摊销；净利润扣得更完整。" },
      { label: "EBITDA vs 现金流", detail: "EBITDA不是现金流，无法替代回款和营运资金分析。" },
    ],
    whyItMatters: "融资、并购和估值沟通常会看它，但 CEO 不能把它误当现金。",
  },
  {
    term: "营运资金",
    ...
    region: "双地",
    category: "营运资金",
    definition: "企业日常经营中由流动资产和流动负债形成的资金占用，常用口径为流动资产减流动负债。",
    plain: "客户欠你的钱、仓库里的货、你欠供应商的钱，三者一起决定公司日常经营会占住多少现金。",
    distinctions: [
      { label: "营运资金 vs 现金余额", detail: "现金余额是现有资金；营运资金解释为什么钱被应收、存货和付款周期占住。" },
      { label: "营运资金 vs 利润", detail: "利润为正也可能因为营运资金恶化而缺钱。" },
    ],
  ...
  },
  {
    ...
    region: "全球通用",
    category: "经营管理",
    definition: "公司对未来收入、成本、费用、现金和资源配置的计划。",
    plain: "预算不是财务部门做的表，而是管理层对未来怎么花钱、怎么赚钱、怎么控制风险的承诺。",
    distinctions: [
      { label: "预算 vs 预测", detail: "预算偏目标和约束；预测偏基于最新事实重新估计未来。" },
      { label: "预算 vs 审批额度", detail: "预算是计划，不代表每笔支出都自动批准。" },
    ],
    whyItMatters: "预算让 CEO 能把战略翻译成资源分配和现金安排。",
  },
  {
    term: "滚动预测",
    alias: "Rolling Forecast",
    region: "全球通用",
    category: "经营管理",
    definition: "定期根据最新经营数据更新未来若干期间的财务预测。",
    plain: "不是年初做完预算就不动，而是每月或每季根据真实情况重新看未来。",
    distinctions: [
      { label: "滚动预测 vs 年度预算", detail: "年度预算通常固定，滚动预测不断更新。" },
      { label: "预测 vs 承诺", detail: "预测是对未来的当前判断，不一定是团队绩效承诺。" },
    ],
    whyItMatters: "它能让公司更早发现收入、现金和成本偏离。",
  },
  {
    term: "税会差异",
    region: "中国",
    category: "中国税务",
    definition: "会计准则下确认的利润与税法下计算应纳税所得额之间的差异。",
    plain: "会计上能算费用，不代表税法一定允许扣；会计上不纳入收入，也不代表税法一定不管。",
    distinctions: [
      { label: "永久性差异 vs 暂时性差异", detail: "永久性差异以后不会转回；暂时性差异只是确认时间不同。" },
      { label: "会计利润 vs 应纳税所得额", detail: "前者按会计规则算，后者按税法规则算。" },
    ],
  ...
  },
  {
    ...
    region: "双地",
    category: "税务基础",
    definition: "企业就其应税所得缴纳的税种，中国和新加坡都有各自的企业所得税/公司所得税制度。",
    plain: "公司赚到税法认可的利润后，需要按当地规则缴税；不是账面净利润乘一个税率这么简单。",
    distinctions: [
      { label: "企业所得税 vs 增值税/GST", detail: "所得税看利润或应税所得；增值税/GST看交易流转。" },
      { label: "会计利润 vs 应税所得", detail: "应税所得要考虑税法调整、优惠和不得扣除项目。" },
    ],
    whyItMatters: "它直接影响利润留存、现金流和税务筹划空间。",
  },
  {
    term: "增值税",
    alias: "VAT",
    region: "中国",
    category: "中国税务",
    definition: "对货物、劳务、服务、无形资产、不动产等流转环节增值额征收的税。",
    plain: "企业卖东西产生销项税，买东西符合条件取得进项税，两者相抵后缴税。",
    distinctions: [
      { label: "增值税 vs 企业所得税", detail: "增值税看交易流转，企业所得税看利润。" },
      { label: "一般计税 vs 简易计税", detail: "一般计税通常可抵扣进项；简易计税按征收率计算，抵扣逻辑不同。" },
    ],
    whyItMatters: "报价、开票、抵扣和现金流都会受到增值税影响。",
  },
  {
    term: "销项税额",
    alias: "Output VAT",
    region: "中国",
    category: "中国税务",
    definition: "纳税人发生应税销售时，按销售额和适用税率计算的增值税税额。",
    plain: "你卖东西时向客户收取或在价格中包含的增值税部分。",
    distinctions: [
      { label: "销项税额 vs 进项税额", detail: "销项来自销售端；进项来自采购端，符合条件时可抵扣销项。" },
      { label: "销项税额 vs 收入", detail: "销项税额通常不是公司的收入，而是代税务机关收取的税。" },
    ],
    whyItMatters: "销项税决定公司当期增值税负担的起点。",
  },
  {
    term: "进项税额",
    alias: "Input VAT",
    region: "中国",
    category: "中国税务",
    definition: "纳税人购进货物、服务等支付或负担的增值税额，符合条件时可从销项税额中抵扣。",
    plain: "公司采购时承担的增值税，如果业务和凭证符合规则，可以拿来抵减销售端要交的增值税。",
    distinctions: [
      { label: "进项税额 vs 成本", detail: "可抵扣进项通常不进成本；不能抵扣的税额可能成为成本或费用的一部分。" },
      { label: "取得专票 vs 可以抵扣", detail: "拿到专票只是基础，还要看业务真实性、用途和抵扣规则。" },
    ],
    whyItMatters: "进项管理不好，会直接增加税负和采购成本。",
  },
  {
    term: "留抵税额",
    alias: "Excess Input VAT Credit",
    region: "中国",
    category: "中国税务",
    definition: "当期可抵扣进项税额大于销项税额时，未抵扣完结转以后期间或按政策申请退还的税额。",
    plain: "买东西产生的可抵扣税比卖东西产生的税多，多出来的一部分暂时留在账上。",
    distinctions: [
      { label: "留抵 vs 退税", detail: "留抵是尚未抵完的税额；退税是符合条件后实际退回现金。" },
      { label: "留抵 vs 亏损", detail: "留抵是增值税抵扣余额，不是企业所得税亏损。" },
    ],
    whyItMatters: "重资产、备货或扩张期公司常见留抵，影响现金流安排。",
  },
  {
    term: "数电发票",
    alias: "全面数字化电子发票",
    region: "中国",
    category: "中国发票",
    definition: "通过电子发票服务平台开具、交付、查验和管理的数字化电子发票。",
    plain: "它不是把纸票扫描成 PDF，而是从开具、流转到归档都更数字化的一套发票机制。",
    distinctions: [
      { label: "数电发票 vs 纸质发票", detail: "数电发票更强调线上开具、交付、查验和归档。" },
      { label: "数电专票 vs 数电普票", detail: "是否具备抵扣意义，要看票种字样、业务用途和抵扣规则。" },
    ],
    whyItMatters: "它改变的是发票取得、交付、归档和核对效率，不只是票面形态。",
  },
  {
    term: "增值税专用发票",
    alias: "VAT Special Invoice",
    region: "中国",
    category: "中国发票",
    definition: "通常用于增值税一般纳税人之间交易，并可在符合条件时作为进项税额抵扣凭证的发票。",
    plain: "专票的核心不是名字高级，而是它可能让购买方抵扣进项税。",
    distinctions: [
      { label: "专票 vs 普票", detail: "专票通常承载抵扣功能；普票更多是交易和入账凭证。" },
      { label: "专票 vs 合同", detail: "合同证明交易约定，专票证明税务票据链路，二者必须匹配。" },
    ],
    whyItMatters: "专票管理不严，会影响进项抵扣和虚开发票风险。",
  },
  {
    term: "增值税普通发票",
    alias: "VAT Ordinary Invoice",
    region: "中国",
    category: "中国发票",
    definition: "用于证明交易和入账的增值税发票类型，通常不具备专票同等的进项抵扣功能。",
    plain: "普票能说明发生过交易、可用于报销或入账，但通常不能像专票那样抵扣进项税。",
    distinctions: [
      { label: "普票 vs 专票", detail: "普票重在交易凭证，专票还可能影响进项抵扣。" },
      { label: "普票 vs 收据", detail: "普票是税务发票；普通收据通常不能替代发票入账和税务处理。" },
    ],
    whyItMatters: "采购和报销场景选错票种，会影响成本、税负和报销合规。",
  },
  {
    term: "价税合计",
    alias: "Tax-inclusive Amount",
    region: "中国",
    category: "中国税务",
    definition: "交易金额中包含增值税税额的合计金额。",
    plain: "客户说付 113 元，如果含 13% 增值税，收入不是 113 元，而要拆出不含税金额和税额。",
    distinctions: [
      { label: "含税价 vs 不含税价", detail: "含税价包含税；不含税价不包含税，报价和毛利计算必须统一口径。" },
      { label: "价税合计 vs 收入", detail: "价税合计中的税额通常不是公司的收入。" },
    ],
    whyItMatters: "报价口径不清会直接造成毛利误判和客户争议。",
  },
  {
    term: "汇算清缴",
    region: "中国",
    category: "中国税务",
    definition: "企业在纳税年度结束后，对全年企业所得税进行汇总计算、调整、补缴或退税的年度申报清算。",
    plain: "平时预缴只是先交一部分，年度结束后要把全年账、税会差异和优惠政策统一算清楚。",
    distinctions: [
      { label: "汇算清缴 vs 预缴", detail: "预缴是期间内先缴；汇算清缴是年度最终校正。" },
      { label: "汇算清缴 vs 审计", detail: "审计关注财务报表公允性；汇算清缴关注所得税计算和申报。" },
    ],
  ...
  },
  {
    ...
    region: "新加坡",
    category: "新加坡税务",
    definition: "新加坡公司在财年结束后向 IRAS 申报的预计应课税收入。",
    plain: "ECI 是先告诉税局：这一年公司大概有多少应税利润，不是最终年度报税。",
    distinctions: [
      { label: "ECI vs Form C-S/Form C", detail: "ECI 是预估申报；Form C-S/Form C 是年度最终所得税申报。" },
      { label: "ECI vs 会计利润", detail: "ECI 关注应税利润，可能需要对会计利润作税务调整。" },
    ],
  ...
  },
  {
    ...
    region: "新加坡",
    category: "新加坡合规",
    definition: "公司财务年度的结束日期，是计算税务、年报、审计和财务报表时间线的基础。",
    plain: "FYE 就是公司账本这一年的截止日。它不是日历年必然 12 月 31 日，可以根据公司情况设置。",
    distinctions: [
      { label: "FYE vs Calendar Year End", detail: "FYE 是公司财年结束日；日历年结束日固定为 12 月 31 日。" },
      { label: "FYE vs Incorporation Date", detail: "成立日是公司注册日期；FYE 是财务年度截止日期。" },
    ],
  ...
  },
  {
    ...
    region: "新加坡",
    category: "新加坡税务",
    definition: "新加坡对本地消费征收的商品与服务税，GST 注册企业通常需要向客户收取并向 IRAS 申报。",
    plain: "它类似消费税。公司达到条件后，要在销售时收 GST，也可以在符合条件时抵扣采购端 GST。",
    distinctions: [
      { label: "GST vs Corporate Income Tax", detail: "GST 看交易消费；公司所得税看应税利润。" },
      { label: "Output Tax vs Input Tax", detail: "Output tax 是销售端收取的 GST；input tax 是采购端支付的 GST。" },
    ],
  ...
  },
  {
    ...
    region: "新加坡",
    category: "新加坡税务",
    definition: "GST 注册企业在应税销售中向客户收取并需要申报的 GST。",
    plain: "你卖东西或服务时向客户收的 GST，通常要交给 IRAS。",
    distinctions: [
      { label: "Output Tax vs Input Tax", detail: "Output tax 来自销售端；input tax 来自采购端。" },
      { label: "Output Tax vs Revenue", detail: "Output tax 不是公司收入，而是代收税款。" },
    ],
    whyItMatters: "如果报价和系统没有正确处理 output tax，申报和客户账单都会出错。",
  },
  {
    term: "Input Tax",
    alias: "进项 GST",
    region: "新加坡",
    category: "新加坡税务",
    definition: "GST 注册企业在采购商品或服务时支付、并在符合条件时可抵扣的 GST。",
    plain: "公司买东西时付出去的 GST，符合规则时可以用来抵减销售端要交的 GST。",
    distinctions: [
      { label: "Input Tax vs Expense", detail: "可抵扣 input tax 通常不是最终费用；不可抵扣部分才可能成为成本。" },
      { label: "Input Tax vs Tax Invoice", detail: "Tax invoice 是凭证，input tax 是税额；有凭证还要满足抵扣条件。" },
    ],
    whyItMatters: "Input tax 管不好，会让公司多交 GST 或留下申报风险。",
  },
  {
    term: "Tax Invoice",
    alias: "新加坡 GST 税务发票",
    region: "新加坡",
    category: "新加坡税务",
    definition: "GST 注册企业在特定应税供应中开具、列示 GST 信息的发票。",
    plain: "它是新加坡 GST 场景下的重要票据，客户可能需要它来支持 input tax claim。",
    distinctions: [
      { label: "Tax Invoice vs Receipt", detail: "Receipt 只是收款凭证；tax invoice 还要包含 GST 相关信息。" },
      { label: "Tax Invoice vs Credit Note", detail: "Tax invoice 记录原交易；credit note 用于冲减或调整。" },
    ],
    whyItMatters: "发票格式错误会影响客户抵扣和公司 GST 记录。",
  },
  {
    term: "Annual Return",
    alias: "AR",
    region: "新加坡",
    category: "新加坡合规",
    definition: "新加坡公司向 ACRA 提交的年度申报，更新公司基本信息、财务报表提交情况等。",
    plain: "它不是报税，而是向公司注册监管机构做年度备案。",
    distinctions: [
      { label: "Annual Return vs Tax Return", detail: "Annual Return 交给 ACRA；Tax Return 交给 IRAS。" },
      { label: "Annual Return vs Financial Statements", detail: "Annual Return 是年度备案动作；财务报表可能是其附件或依据。" },
    ],
    whyItMatters: "晚交 AR 会影响公司和董事合规记录。",
  },
  {
    term: "XBRL",
    region: "新加坡",
    category: "新加坡合规",
    definition: "用于结构化提交财务报表数据的电子报告格式。",
    plain: "它不是 PDF，而是一种让监管系统能读取和比较财务数据的格式。",
    distinctions: [
      { label: "XBRL vs PDF Financial Statements", detail: "PDF 适合人工阅读；XBRL 适合系统读取和监管分析。" },
      { label: "XBRL vs Accounting Standards", detail: "XBRL 是提交格式；会计准则决定报表怎么确认和计量。" },
    ],
    whyItMatters: "需要提交 XBRL 的公司必须提前准备格式和映射，不能临近截止日才处理。",
  },
  {
    term: "CPF",
    ...
    region: "新加坡",
    category: "新加坡薪酬",
    definition: "新加坡针对符合条件员工的法定公积金制度，通常涉及雇主和员工双方供款。",
    plain: "发工资不是把净工资打给员工就结束。符合条件时，公司还要按规则缴 CPF。",
    distinctions: [
      { label: "CPF vs Salary", detail: "Salary 是工资报酬；CPF 是法定供款安排。" },
      { label: "Employer CPF vs Employee CPF", detail: "雇主供款是公司成本；员工供款从员工工资中扣除。" },
    ],
    whyItMatters: "它直接影响 payroll、现金流和用工合规。",
  },
  {
    term: "Itemised Payslip",
    alias: "分项工资单",
    region: "新加坡",
    category: "新加坡薪酬",
    definition: "列明工资组成、扣款、支付期等信息的工资单。",
    plain: "员工看到的不只是一个到账数字，还要知道基本工资、津贴、扣款、加班等怎么算出来。",
    distinctions: [
      { label: "Payslip vs Payroll Register", detail: "Payslip 面向员工；payroll register 是公司内部薪资记录。" },
      { label: "Payslip vs CPF Submission", detail: "Payslip 说明工资构成；CPF submission 是供款申报动作。" },
    ],
    whyItMatters: "工资单不清楚，容易引发劳资争议和合规问题。",
  },
];
